package com.xatu.temperature.filter;
...
public class SwaggerCorsFilter implements Filter{
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        res.setHeader("Access-Control-Allow-Headers", "Origin, X-Requested-With, Content-Type, Accept, Accept-Encoding, " +
                "Accept-Language, Host, Referer, Connection, User-Agent, authorization, Authorization, connection, sw-useragent, sw-version, dhost, dport");
